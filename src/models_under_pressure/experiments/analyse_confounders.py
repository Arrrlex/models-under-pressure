...
from models_under_pressure.config import EVAL_DATASETS, SYNTHETIC_DATASET_PATH
...
if __name__ == "__main__":
    ...
    filtered_dataset.save_to(
        Path(str(SYNTHETIC_DATASET_PATH).replace(".jsonl", "_conf_free.jsonl"))
    )
